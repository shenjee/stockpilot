...
TEXT = {
    "zh": {
        ...
        "market_label": "市场",
        "timeframe_label": "周期",
        "enable_alignment_label": "启用多周期对齐检查",
        "alignment_timeframes_label": "对齐周期（可多选）",
        ...
        "display_header": "显示",
        "show_candle_tip_label": "显示 K 线数据提示",
        "overview_header": "数据卡",
    ...
    "en": {
        ...
        "enable_alignment_label": "Enable multi-timeframe alignment check",
        "alignment_timeframes_label": "Alignment timeframes (multi-select)",
        ...
        "show_candle_tip_label": "Show K-line tooltip",
