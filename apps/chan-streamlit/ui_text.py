...
TEXT = {
    "zh": {
        ...
        "multi_timeframe_header": "多周期联立数据",
        "no_signal_replay": "没有可展示的信号回放结果。",
        "no_candidate_replay": "没有可展示的买卖点回放结果。",
        "no_multi_timeframe": "没有可展示的多周期结果。",
        "no_multi_timeframe_base": "多周期结果中缺少基础周期 {timeframe}，无法继续展示主图。",
        ...
        "overview_header": "数据卡",
        "overview_summary": "基础周期 {timeframe} 联动了 {level_count} 个周期视角：{timeframes}。",
        "overview_col_field": "字段",
        "overview_col_value": "值",
        "overview_field_timeframe": "基础周期",
        "overview_field_linked_timeframes": "联动周期",
        ...
        "multi_timeframe_summary": "多周期联立结果覆盖 {level_count} 个周期，其中 higher {higher_count} 个，lower {lower_count} 个。",
        "multi_timeframe_role_base": "基础周期",
        "multi_timeframe_role_higher": "高一级周期",
        "multi_timeframe_role_lower": "低一级周期",
        "multi_timeframe_level_summary": "{role}，共 {bar_count} 根 K 线，{warning_count} 条告警，{signal_count} 条信号序列。",
        "multi_timeframe_empty": "当前没有可展示的多周期联立明细。",
        "multi_timeframe_card_field": "字段",
        "multi_timeframe_card_value": "值",
        "multi_timeframe_field_role": "角色",
        "multi_timeframe_field_latest_bar": "最新 K 线",
        "multi_timeframe_field_latest_close": "最新收盘",
        "multi_timeframe_field_bar_count": "K 线数量",
        "multi_timeframe_field_stroke_count": "笔数量",
        "multi_timeframe_field_segment_count": "线段数量",
        "multi_timeframe_field_pivot_zone_count": "中枢数量",
        "multi_timeframe_field_signal_series_count": "信号序列数",
        "multi_timeframe_field_active_signal_count": "当前激活信号数",
        "multi_timeframe_field_warning_count": "告警数",
        "multi_timeframe_field_candidate_count": "买卖点数量",
        "layer_fractals": "显示分型",
        "layer_strokes": "显示笔",
        "layer_segments": "显示线段",
    ...
    "en": {
        ...
        "tab_summary": "Summary",
        "tab_multi_timeframe": "Multi-Timeframe",
        ...
        "multi_timeframe_header": "Multi-Timeframe Data",
        "no_signal_replay": "No signal replay data is available.",
        "no_candidate_replay": "No buy/sell replay data is available.",
        "no_multi_timeframe": "No multi-timeframe data is available.",
        "no_multi_timeframe_base": "The multi-timeframe payload is missing the base timeframe {timeframe}.",
        ...
        "overview_summary": "Base timeframe {timeframe} is linked with {level_count} timeframe views: {timeframes}.",
        "overview_col_field": "Field",
        "overview_col_value": "Value",
        "overview_field_timeframe": "Base Timeframe",
        "overview_field_linked_timeframes": "Linked Timeframes",
        ...
        "multi_timeframe_summary": "Multi-timeframe result covers {level_count} levels, with {higher_count} higher and {lower_count} lower views.",
        "multi_timeframe_role_base": "base",
        "multi_timeframe_role_higher": "higher",
        "multi_timeframe_role_lower": "lower",
        "multi_timeframe_level_summary": "{role}, {bar_count} bars, {warning_count} warnings, and {signal_count} signal series.",
        "multi_timeframe_empty": "No multi-timeframe detail is available.",
        "multi_timeframe_card_field": "Field",
        "multi_timeframe_card_value": "Value",
        "multi_timeframe_field_role": "Role",
        "multi_timeframe_field_latest_bar": "Latest Bar",
        "multi_timeframe_field_latest_close": "Latest Close",
        "multi_timeframe_field_bar_count": "Bar Count",
        "multi_timeframe_field_stroke_count": "Stroke Count",
        "multi_timeframe_field_segment_count": "Segment Count",
        "multi_timeframe_field_pivot_zone_count": "Pivot Zone Count",
        "multi_timeframe_field_signal_series_count": "Signal Series",
        "multi_timeframe_field_active_signal_count": "Active Signals",
        "multi_timeframe_field_warning_count": "Warnings",
        "multi_timeframe_field_candidate_count": "Buy/Sell Points",
