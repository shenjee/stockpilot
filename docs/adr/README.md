...
| [0005](./0005-t0-chart-engine-and-logical-time-axis.md) | Proposed | T+0 图表引擎与逻辑时间轴能力 | 图表 Spike |
| [0006](./0006-electron-managed-python-process.md) | Proposed | Electron 管理 Python 服务生命周期 | Electron/Python Spike |
| [0007](./0007-local-python-transport.md) | Proposed | Electron 与 Python 的本地请求/事件传输 | Electron/Python Spike；依赖 0006 的进程边界 |
| [0008](./0008-czsc-update-and-rebuild-strategy.md) | Proposed | 5 分钟 CZSC 推进、重建与回放一致性 | CZSC Spike |
